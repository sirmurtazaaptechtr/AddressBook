<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    while($rows = mysqli_fetch_assoc($data)){
      pr($rows);
      if($rows['username'] == $username && $rows['password'] == $password && $rows['role_id'] == 1) {
        $isLogin = true;
        $_SESSION['adminLogin'] = true;
        $_SESSION['userid'] = $rows['user_id'];
        break;
      }else {        
        $loginError = "Login Fail! incorrect username or password.";
      }
    }
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center text-danger small"><?php echo $loginError;?></p>
                  </div>
