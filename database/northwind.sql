...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2024 at 04:24 PM
...
INSERT INTO `categories` (`CategoryID`, `CategoryName`, `Description`, `MainCategoryID`) VALUES
(1, 'Beverages', 'Soft drinks, coffees, teas, beers, and ales', 1),
...
INSERT INTO `logins` (`username`, `password`, `user_id`, `role_id`) VALUES
('admin', 'admin', 0, 1),
('urooj', 'password', 102, 5);
...
CREATE TABLE `main category` (
  ...
  `MainCategoryName` varchar(25) NOT NULL,
...
INSERT INTO `main category` (`MainCategoryID`, `MainCategoryName`, `Description`) VALUES
(1, 'Saman', 'Koi bhi Saman');
...
(1, 'administrator', 'Person who manages the application.'),
(2, 'employee', 'A person who processes the order.'),
(3, 'shipper', 'A person/company that delivers orders.'),
(4, 'suppliers', 'A person/company that supplies goods/products.'),
(5, 'customer', 'A person who purchases/places order.');
...
--
-- Indexes for table `main category`
--
...
--
-- AUTO_INCREMENT for table `main category`
--
ALTER TABLE `main category`
  MODIFY `MainCategoryID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `categories`
  ADD CONSTRAINT `categories_ibfk_1` FOREIGN KEY (`MainCategoryID`) REFERENCES `main category` (`MainCategoryID`) ON DELETE SET NULL ON UPDATE CASCADE;
